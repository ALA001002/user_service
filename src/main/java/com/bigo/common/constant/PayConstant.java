...
public class PayConstant {
    ...
    public final static String CHANNEL_NAME_YOPPAY = "yoppay"; 				// 渠道名称:易宝支付
	...
	public final static Integer PAY_STATUS_REFUND = 4; 	// 已退款

	public final static Integer TRANS_STATUS_INIT = 0; 		// 初始态
	public final static Integer TRANS_STATUS_TRANING = 1; 		// 转账中
	public final static Integer TRANS_STATUS_SUCCESS = 2; 		// 成功
	public final static Integer TRANS_STATUS_FAIL = 3; 		// 失败
	public final static Integer TRANS_STATUS_COMPLETE = 4; 	// 业务完成

	public final static Integer TRANS_RESULT_INIT = 0; 		// 不确认结果
	public final static Integer TRANS_RESULT_REFUNDING = 1; 	// 等待手动处理
	public final static Integer TRANS_RESULT_SUCCESS = 2; 		// 确认成功
	public final static Integer TRANS_RESULT_FAIL = 3; 		// 确认失败
	...
	public final static Integer REFUND_RESULT_INIT = 0; 		// 不确认结果
	public final static Integer REFUND_RESULT_REFUNDING = 1; 	// 等待手动处理
	public final static Integer REFUND_RESULT_SUCCESS = 2; 	// 确认成功
	public final static Integer REFUND_RESULT_FAIL = 3; 		// 确认失败

	public final static Integer AGENTPAY_STATUS_INIT = 0; 		// 待处理(初始态)
	public final static Integer AGENTPAY_STATUS_ING = 1; 		// 代付中
	public final static Integer AGENTPAY_STATUS_SUCCESS = 2; 	// 成功
	public final static Integer AGENTPAY_STATUS_FAIL = 3; 		// 失败
	...
	public final static Integer MCH_NOTIFY_STATUS_NOTIFYING = 1;	// 通知中
	public final static Integer MCH_NOTIFY_STATUS_SUCCESS = 2;		// 通知成功
	public final static Integer MCH_NOTIFY_STATUS_FAIL = 3;		// 通知失败
	...
	public static final String PAY_METHOD_PAY_URL = "redirectUrl";	//重定向URL
    ...
    //易宝支付回调状态码
    public final static String TWENTY_FIVE = "0025";
    public final static String TWENTY_SIX = "0026";
    public final static String TWENTY_SEVEN = "0027";
    public final static String TWENTY_EIGHT = "0028";
    public final static String TWENTY_NINE = "0029";
    public final static String THIRTY = "0030";
