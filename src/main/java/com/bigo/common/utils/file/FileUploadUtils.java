...
public class FileUploadUtils
{
     ...
     * @throws IOException
     */
    public static boolean checkIsImage(InputStream inputStream) throws IOException {
        ...
        //校验是否为xls或者xlsx文件
        if (fileHead.contains(FileType.JPEG.getValue()) || fileHead.contains(FileType.PNG.getValue())) {
            return true;
        }
        return false;
    }
