...
import com.bigo.project.system.mapper.SysNoticeMapper;
...
public class SysNoticeServiceImpl implements ISysNoticeService
{
    ...
    @Override
    public SysNotice selectNoticeByKey(String keyWord, String lang) {
        SysNotice param = new SysNotice();
        param.setKeyWord(keyWord);
        param.setLang(lang);
        return noticeMapper.selectNoticeByKey(param);
    }
}
